                        ...
                        <div class="container">
                            <div class="content-part">
                                <div class="sl-img wow fadeInDown" data-wow-delay="600ms" data-wow-duration="2000ms">
                                    <img src="assets/images/slider/style2/house-repair.png" alt="slider">
                                </div>
                    ...
                    <div class="row">
                           ...
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="assets/images/services/style6/copy-machine.png" alt="">
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                                       <h3 class="services-title"><a href="software-development.php">Photocopier Printer</a></h3>
                                   </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-25">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="assets/images/services/style6/air-purifier.png" alt="">
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                                       <h3 class="services-title"><a href="software-development.php">Air Purifier</a></h3>
                                   </div>
                                   <div class="services-desc">
                                       <p>
                                           At vero eos et accusamus etiusto odio praesentium accusamus etiusto odio data center for managing database.
                        ...
                        <div class="col-lg-4 col-md-6 mb-25">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="assets/images/services/style6/trolley.png" alt="">
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                                       <h3 class="services-title"><a href="software-development.php">Trolley</a></h3>
                                   </div>
                                   <div class="services-desc">
                                       <p>
                                           At vero eos et accusamus etiusto odio praesentium accusamus etiusto odio data center for managing database.
                        ...
                        <div class="col-lg-4 col-md-6 mb-25">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="assets/images/services/style6/lamination.png" alt="">
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                                       <h3 class="services-title"><a href="software-development.php">Lamination</a></h3>
                                   </div>
                                   <div class="services-desc">
                                       <p>
                                           At vero eos et accusamus etiusto odio praesentium accusamus etiusto odio data center for managing database.
                        ...
                        <div class="col-lg-4 col-md-6 mb-25">
                           <div class="services-item">
                               <div class="services-icon">
                                   <div class="image-part">
                                       <img src="assets/images/services/style6/shredder.png" alt="">
                                   </div>
                               </div>
                               <div class="services-content">
                                   <div class="services-text">
                                ...
                                <div class="col-md-6 mb-60">
                                    <div class="rs-addon-number">
                                        <div class="number-text">
                                            ...
                                            <div class="number-title">
                                                <h3 class="title">Drop Off Your Item</h3>
                                            </div>
                                            <p class="number-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus, in porttitor theo lacus egestas.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 sm-mb-60">
                                    <div class="rs-addon-number">
                                        <div class="number-text">
                                            <div class="number-area">
                                                3.
                                            ...
                                            <div class="number-title">
                                                <h3 class="title">Pick Up Your Item</h3>
                                            </div>
                                            <p class="number-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus, in porttitor theo lacus egestas.</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="rs-addon-number">
                                        <div class="number-text">
                                            ...
                                            <div class="number-title">
                                                <h3 class="title">Resolve Continued Issues</h3>
                                            </div>
                                            <p class="number-txt">Quisque placerat vitae lacus ut scelerisque. Fusce luctus odio ac nibh luctus, in porttitor theo lacus egestas.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 pl-45 md-pl-15 md-mb-30">
                            ...
                            <ul class="site-map">
                                ...
                                <li><a href="software-development.php">Web Development</a></li>
                    ...
                    <div class="row y-middle">
                        <div class="col-lg-6 text-right md-mb-10 order-last">
                            <ul class="copy-right-menu">
                                <li><a href="Web Development.html">Home</a></li>
                                <li><a href="Web Development.html">About</a></li>
                                <li><a href="Web Development.html">Blog</a></li>
                                <li><a href="Web Development.html">Shop</a></li>
                                <li><a href="Web Development.html">FAQs</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <div class="copyright">
