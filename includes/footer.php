                ...
                <div class="col-lg-3 col-md-12 col-sm-12 md-mb-30">
                    ...
                    <ul class="address-widget">
                        <li>
                            ...
                            <div class="desc">
                                14 Pallisree, 1st floor,back side Room no-A4,
                                Near Nabarun Club, Kolkata-700092
                            </div>
                        </li>
                        <li>
                            <i class="flaticon-call"></i>
                            <div class="desc">
                               <a href="tel:+91 9163105723">+91 9163105723</a>
                               <a href="tel:+91 9051887542">+91 9051887542</a>
                            </div>
                        </li>
                        <li>
                            <i class="flaticon-email"></i>
                            <div class="desc">
                                <a href="mailto:ask@silverlinerinfotech.co.in">ask@silverlinerinfotech.co.in</a>
                            </div>
                        </li>
                        <li>
                            <i class="flaticon-clock-1"></i>
                            <div class="desc">
                                Office Hours: 9:30AM - 5:30PM <br>Monday to Friday
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row y-middle">
                ...
                <div class="col-lg-6">
                    <div class="copyright">
                        <p>&copy; 2021 All Rights Reserved by <a href="idnex.php">Silver Liner Infotech</a></p>
                    </div>
                </div>
            </div>
        </div>
